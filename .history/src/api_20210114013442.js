...
export const deliveryManDeliveries = async (deliveryManId ) => {
	const resp = await fetch(process.env.REACT_APP_CHAP_CHAP_API_BASE_URL + "/delivery_men/" +deliveryManId +  "/deliveries?status=STATUS_PROCESSING_PARCEL_DELIVERY_REQUEST", {
		method: "GET",
		headers: {
			'Content-Type': 'application/json',
			'Accept': 'application/json',
